  ...
  return (
    <div className="h-screen bg-zinc-950 text-zinc-50 flex justify-center items-center">
      <div className="flex w-[1100px] flex-col gap-6">
        ...
        <main className="relative flex overflow-hidden rounded-large border border-zinc-800 bg-zinc-900 shadow">
          ...
          <aside className="w-80 border-l border-zinc-800 bg-zinc-900">
            <div className="">
              ...
              <nav className="relative flex flex-col gap-4 p-6">
                <button className="flex item-center gap-3 text-sm text-zinc-400">
